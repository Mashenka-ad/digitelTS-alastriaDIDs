...
async function mainAddEntity() {
  ...
  const transactionAddEntity = await transactionFactory.identityManager.addEntity(
    ...
    configData.entityDataProvider.name,
    configData.entityDataProvider.cif,
    configData.entityDataProvider.urlLogo,
    configData.entityDataProvider.urlCreateAID,
    configData.entityDataProvider.urlAOA,
    configData.entityDataProvider.status
  )
